...
https://rufalo.github.io/bejeweled/
## Development

To experiment locally, run a simple static server from the project root (for example `python3 -m http.server`) and visit `http://localhost:8000/docs/`.
